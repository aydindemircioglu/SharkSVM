...
#ifndef SHARK_LLSVMDATAMODEL_H
#define SHARK_LLSVMDATAMODEL_H

#include "AbstractSVMDataModel.h"
#include "SharkSVM.h"
#include "DataModels/BudgetedSVMDataModel.h"
...
//! \sa
    ...
    class LLSVMDataModel : public BudgetedSVMDataModel {
        private:
        ...
        public:
            ...
            virtual ~LLSVMDataModel();


            /// \brief From INameable: return the class name.
            std::string name() const {
                return "LLSVMDataModel";
            }
