...
namespace shark {
    ...
    class MergeBudgetMaintenanceStrategy: public AbstractBudgetMaintenanceStrategy<InputType> {
        ...
        public:
            ...
            virtual void addToModel (ModelType& model, InputType &alpha, ElementType &supportVector) {
                ...
                throw (SHARKSVMEXCEPTION ("MergeBudgetMaintenanceStrategy: There is no default merging strategy for the InputType you provided! Please specialize this class."));
            }
    ...
    class MergeBudgetMaintenanceStrategy<RealVector>: public AbstractBudgetMaintenanceStrategy<RealVector> {
        ...
        public:
            ...
            virtual ~MergeBudgetMaintenanceStrategy() {
            }
            ...
            virtual void reduceBudget (ModelType& model, size_t firstIndex)
            {
                ...
                double maxDegradation = -std::numeric_limits<double>::infinity();
                double minH = 0.0;
            ...
            size_t trueFirstIndex = 0;
                for (size_t currentFirstIndex = 0; currentFirstIndex < maxIndex; currentFirstIndex++)
                {
                ...
                for (size_t currentIndex = 0; currentIndex < maxIndex; currentIndex++)
                {
                    ...
                    if (currentDegradation < minDegradation)
                    {
                        ...
                        trueFirstIndex = currentFirstIndex;
                    }
                    if (currentDegradation > maxDegradation)
                    {
                        maxDegradation = currentDegradation;
                    }      
                }
